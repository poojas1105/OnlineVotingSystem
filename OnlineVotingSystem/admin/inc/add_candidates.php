...
<div class="row my-3">
    ...
    <div class="col-8">
        ...
        <table class="table">
                ...
                <?php
                    ...
                    if($isAnyCandidateAdded > 0)
                    {
                        ...
                        while($row = mysqli_fetch_assoc($fetchingData))
                        {
                            ...
                            $fetchingElectionsName = mysqli_query($db, "SELECT * FROM elections WHERE id = '". $election_id ."' ") or die(mysqli_error($db));
                            $execFetchingElectionNameQuery = mysqli_fetch_assoc($fetchingElectionsName);
            ...
            ?>
                        <tr>
                            <td colspan="7"> No candidate is added yet. </td>
                        </tr>
            <?php
                    }
